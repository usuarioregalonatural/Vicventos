...
class Widget_Newspaper_X_Posts_A extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$filepath = get_template_directory() . '/inc/libraries/widgets/widget-newspaper-x-posts-a/layouts/default.php';
